...
// create main scene
        ...
        this.scene.position.set(0, -500, 0);
...
// camera
        ...
        this.camera.position.set(400, 0, 1800);   //
...
// Stats preparing
        ...
        this.stats.domElement.style.top = '152px';
...
// Add axes, The X axis is red. The Y axis is green. The Z axis is blue.
        ...
        gridY = new THREE.GridHelper(600, 8);
...
// create geometries 
//create link1
        Cylinder1 = new THREE.Mesh(new THREE.CylinderGeometry(100, 100, 30, 100), new THREE.MeshNormalMaterial());
...
//Link3
        ...
        this.Link3Mesh.position.set(190, 210, 0);
        //this.scene.add(axes);
        this.link2Mesh.add(this.Link3Mesh);
        ...
        this.Link4Mesh.position.set(0, 310, 0);
