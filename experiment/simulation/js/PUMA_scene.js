...
// camera
        ...
        this.camera.position.set(1000, 100, 1600);   //
...
// Stats preparing
        ...
        this.stats.domElement.style.top = '150px';
...
// create geometries 
//create link1
        Cylinder1 = new THREE.Mesh(new THREE.CylinderGeometry(120, 120, 30, 100), new THREE.MeshNormalMaterial());
